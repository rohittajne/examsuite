...
<title>Test Seter Registration</title>
<style type="text/css">
body {
...
<body>
<table width="1318" height="906" border="1">
  <tr>
    <td height="174">&nbsp;</td>
  </tr>
  <tr>
    <td height="548"><table width="484" height="542" border="5" align="center">
        <tr>
          <td width="468" height="536"><table width="476" border="0" align="center">
      <tr>
        <td height="54" colspan="2" align="center" valign="middle"><h2><em><strong>Test Seter Registration</strong></em></h2></td>
        </tr>
      <tr>
        <td width="170" height="38"><strong>Name :-</strong></td>
      ...
      <tr>
        <td height="50"><strong>Password :-</strong></td>
...
$d=getdate();
$id=$_POST["flag"];
$res=move_uploaded_file($_FILES[pp]["tmp_name"],"tstuploads/$f");
$fp="tstuploads/".$f;
$dob=$bd." / ". $bm." / ".$byr;
...
if($error==0)
{
$s1="INSERT INTO `examsuite`.`tstrec` (`name`, `gender`, `birthdate`, `add`, `contact`, `email`, `bloodgroup`, `photo`, `password`) VALUES (
'$nm', '$gn', '$dob', '$add', '$con', '$eid', '$bg', '$fp', '$pwd');
";
}
...
var sprypassword1 = new Spry.Widget.ValidationPassword("sprypassword1", {minChars:6, maxChars:30, minAlphaChars:1, minUpperAlphaChars:1, minSpecialChars:1, validateOn:["blur", "change"], maxAlphaChars:20, maxNumbers:20, maxUpperAlphaChars:20, maxSpecialChars:20});
</script>
</body>
</html>
